    ...
    private fun handleClick(
        ...
        if (p1 != null && p2 != null) {
            ...
            if (EffectiveZone.getZoneByNamespacedKey(zoneKey) != null) {
                ...
                player.sendMessage(Locale.getMessage("items.zone_registering_selector.registered", zoneKey, box.id))
            } else {
                player.sendMessage(Locale.getMessage("items.zone_registering_selector.zone_not_registered", zoneKey))
            }
        }
