package ru.hukm.effectiveSpigot.minecraft.mcv.v1_21_11.chunk

import net.minecraft.world.level.chunk.LevelChunkSection
import org.bukkit.craftbukkit.v1_21_R7.CraftWorld
import ru.hukm.effectiveSpigot.minecraft.mcv.interfaces.chunk.IMcvEffectiveChunkManager
import ru.hukm.effectiveSpigot.minecraft.mcv.v1_21_11.McvModuleV1_21_11
            ...
            for(y in 0 until 16) {
                for(x in 0 until 16) {
                    for(z in 0 until 16) {
                        ...
                        types[i] = McvModuleV1_21_11.mcvBlockToMaterialIndex(type)
                        i++
                    }
                }
            }
